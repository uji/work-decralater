...
This is a sample template for slack-api - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name slack-api --query 'Stacks[].Outputs'
```
